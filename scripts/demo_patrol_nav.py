...
class PatrolNav():
    def __init__(self):
        ...
        self.locations = dict()
        self.locations['one']   = Pose(Point( 0.956, -3.052, 0.000), Quaternion(0.000, 0.000, -0.814, 0.580))
        self.locations['two']   = Pose(Point(-6.590, -5.826, 0.000), Quaternion(0.000, 0.000, 0.668, 0.744))
        self.locations['three'] = Pose(Point(-5.119, -0.246, 0.000), Quaternion(0.000, 0.000, 0.828, 0.561))
        self.locations['four']  = Pose(Point(-5.152,  8.847, 0.000), Quaternion(0.000, 0.000, 0.744, 0.668))
        self.locations['five']  = Pose(Point( 5.340,  9.154, 0.000), Quaternion(0.000, 0.000, -0.689 ,0.724))
        self.locations['six']   = Pose(Point(4.956,  0.963, 0.000), Quaternion(0.000, 0.000, -0.693, 0.721))
