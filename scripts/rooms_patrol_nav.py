...
class PatrolNav():
    def __init__(self):
        ...
        self.locations = dict()
        self.locations['one']   = Pose(Point( 4.776, 0.026, 0.000), Quaternion(0.000, 0.000, 0.999, -0.015))
        self.locations['two']   = Pose(Point(-0.289, -3.382, 0.000), Quaternion(0.000, 0.000, 0.968, 0.252))
        self.locations['three'] = Pose(Point(2.388, 3.768, 0.000), Quaternion(0.000, 0.000, 0.975, -0.222))
        self.locations['four']  = Pose(Point(-5.209,  -3.189, 0.000), Quaternion(0.000, 0.000, 0.982, -0.186))
        self.locations['five']  = Pose(Point(-5.085, 7.022, 0.000), Quaternion(0.000, 0.000, 0.613 ,0.790))
        self.locations['six']   = Pose(Point(5.066,  7.868, 0.000), Quaternion(0.000, 0.000, -0.580, 0.815))
	...
	sequeue_goal = ['bedroom1', 'bedroom2', 'toilet', 'parlour', 'bedroom3', 'kitchen']
	    ...
	    location_goal = sequeue_goal[target_num]
            rospy.loginfo("Going to: " + str(location_goal))
